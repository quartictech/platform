...
export const SEARCH = "weyl/Home/SEARCH";
export const SEARCH_DONE = "weyl/Home/SEARCH_DONE";
export const BUCKET_COMPUTATION_START = "weyl/Home/BUCKET_COMPUTATION_START";

export const UI_TOGGLE = "weyl/Home/UI_TOGGLE";
export const SELECT_FEATURES = "weyl/Home/SELECT_FEATURES";
export const CLEAR_SELECTION = "weyl/Home/CLEAR_SELECTION";

export const NUMERIC_ATTRIBUTES_LOAD = "weyl/Home/NUMERIC_ATTRIBUTES_LOAD";
export const NUMERIC_ATTRIBUTES_LOADED = "weyl/Home/NUMERIC_ATTRIBUTES_LOADED";
export const CHART_SELECT_ATTRIBUTE = "weyl/Home/CHART_SELECT_ATTRIBUTE";

export const LAYER_CREATE = "weyl/Home/LAYER_CREATE";
